...
INSERT INTO course (id, author_id, difficulty_id, name, short_description, long_description, trailer_url, thumbnail_url, icon_url, status, created_at, updated_at) VALUES
(course_id_seq.nextval, 1, 1, 'Informatika 101', 'Úvod do informatiky a programovania', STRINGDECODE('## Čo sa naučíš\n\n- Algoritmy\n- Python\n- Logicky myslieť\n- Binárnu sústavu\n\n## Čo už treba vedieť\n\nJe dôležité vedieť algoritmy, kriticky myslieť a poznať všetky podcasty naspamäť. \nOdporúčame si najprv prejsť kurz [Kotlin základy](/course/2). \n\nOkrem toho sme dali dokopy pár linkov, ktoré by ti mohli v tom taktiež pomôcť.\n\n- [What is Kotlin](www.youtube.com)'), 'https://www.youtube.com/embed/z1At9Jk4sqE', null, 'http://streetofcode.sk/wp-content/uploads/2022/04/python-logo.png', 'PUBLIC', '2007-12-03T10:15:30+01:00', '2007-12-03T10:15:30+01:00' ),
(course_id_seq.nextval, 2, 2, 'Kryptografia', 'Úvod do kryptografie', STRINGDECODE('Jeden z tych lepsich kurzov o kryptografii'), null, 'http://streetofcode.sk/wp-content/uploads/2022/06/Frame-70.png', 'http://streetofcode.sk/wp-content/uploads/2022/04/kotlin-logo.png', 'DRAFT', '2007-12-03T10:15:30+01:00', '2007-12-03T10:15:30+01:00');
