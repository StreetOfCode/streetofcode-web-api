INSERT INTO public.course (id, created_at, icon_url, lectures_count, long_description, name, resources, short_description, slug, status, thumbnail_url, trailer_url, updated_at, author_id, difficulty_id) VALUES (nextval('course_id_seq'), '2022-09-25 10:26:15.808704 +00:00', 'http://streetofcode.sk/wp-content/uploads/2022/09/Group-9.png', 41, 'TODO', 'Spring Boot - Kotlin', null, 'Nauč sa veľmi žiadaný backendový framework v spolupráci s Kotlinom', 'spring-boot-kotlin', 'DRAFT', '', '746275268', '2022-09-25 10:55:33.505901 +00:00', 1, 2);
